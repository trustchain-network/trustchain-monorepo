...
export class CreateUser1711449467119 implements MigrationInterface {
    name = 'CreateUser1711449467119'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "membership" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "status" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "createdBy" character varying, "updatedBy" character varying, "deletedBy" character varying, CONSTRAINT "PK_83c1afebef3059472e7c37e8de8" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "nfc" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "uid" character varying NOT NULL, "nfcDetail" character varying NOT NULL, "piccData" character varying NOT NULL, "fileData" character varying NOT NULL, "counter" integer NOT NULL, "status" integer NOT NULL, "tagStatus" integer NOT NULL, "encryptionMode" character varying NOT NULL, "encryptedShareKey" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "createdById" uuid, "updatedById" uuid, "deletedById" uuid, CONSTRAINT "PK_42e5e8f523339faa405808e63a1" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "tag-status" ("id" integer NOT NULL, "name" character varying NOT NULL, CONSTRAINT "PK_3db3be01acaf34812e8058dc87a" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "nfc-status" ("id" integer NOT NULL, "name" character varying NOT NULL, CONSTRAINT "PK_0d760ea4e0bae9de416ff644ada" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "team" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "description" character varying, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "userId" uuid, "createdById" uuid, "updatedById" uuid, CONSTRAINT "UQ_cf461f5b40cf1a2b8876011e1e1" UNIQUE ("name"), CONSTRAINT "PK_f57d8293406df4af348402e4b74" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "icType" ("id" integer NOT NULL, "name" character varying NOT NULL, CONSTRAINT "PK_36e000c4a382c1923ca70bded9f" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "user" ADD CONSTRAINT "FK_9ff85c3022ae20faa55b0d12bf1" FOREIGN KEY ("membershipId") REFERENCES "membership"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "user" DROP CONSTRAINT "FK_9ff85c3022ae20faa55b0d12bf1"`);
        ...
        await queryRunner.query(`DROP TABLE "icType"`);
        ...
        await queryRunner.query(`DROP TABLE "nfc-status"`);
        await queryRunner.query(`DROP TABLE "tag-status"`);
