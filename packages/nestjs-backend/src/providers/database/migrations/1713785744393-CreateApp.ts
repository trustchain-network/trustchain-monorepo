...
export class CreateApp1713785608727 implements MigrationInterface {
  name = 'CreateApp1713785608727';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "key" ADD CONSTRAINT "FK_69572a81a9c722651ca1b44651b" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "key" DROP CONSTRAINT "FK_69572a81a9c722651ca1b44651b"`,
    );
    await queryRunner.query(
