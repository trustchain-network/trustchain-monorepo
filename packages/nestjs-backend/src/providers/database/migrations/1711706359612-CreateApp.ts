...
export class CreateApp1711706359612 implements MigrationInterface {
  name = 'CreateApp1711706359612';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "icType" ("id" integer NOT NULL, "name" character varying NOT NULL, CONSTRAINT "PK_36e000c4a382c1923ca70bded9f" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
