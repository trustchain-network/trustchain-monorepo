...
export class CreateUser1710775919340 implements MigrationInterface {
    name = 'CreateUser1710775919340'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "nfc" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "uid" character varying NOT NULL, "nfcDetail" character varying NOT NULL, "piccData" character varying NOT NULL, "fileData" character varying NOT NULL, "counter" integer NOT NULL, "status" character varying NOT NULL, "encryptionMode" character varying NOT NULL, "encryptedShareKey" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "createdBy" character varying, "updatedBy" character varying, "deletedBy" character varying, CONSTRAINT "PK_42e5e8f523339faa405808e63a1" PRIMARY KEY ("id"))`);
