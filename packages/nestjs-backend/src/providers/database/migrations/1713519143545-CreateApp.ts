...
export class CreateApp1713519143545 implements MigrationInterface {
    name = 'CreateApp1713519143545'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "key" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "key" character varying NOT NULL, "publicKey" character varying, "subscriptionId" character varying, "userId" uuid, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "createdBy" character varying, "updatedBy" character varying, "deletedBy" character varying, CONSTRAINT "PK_5bd67cf28791e02bf07b0367ace" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "key" ADD CONSTRAINT "FK_69572a81a9c722651ca1b44651b" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "nfcDetail" ADD CONSTRAINT "FK_5b00ad4f4af59beba7007cc9c37" FOREIGN KEY ("createdById") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "nfcDetail" ADD CONSTRAINT "FK_cd77f5ec4b307314a2c048acbc4" FOREIGN KEY ("updatedById") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "nfcDetail" ADD CONSTRAINT "FK_71781fd56d77ab543a69a72b78b" FOREIGN KEY ("deletedById") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "nfc" ADD CONSTRAINT "FK_5e5be3957301bc1bc91d2b88617" FOREIGN KEY ("detailId") REFERENCES "nfcDetail"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "nfc" ADD CONSTRAINT "FK_f00e4bca6e854074855b2f6ea45" FOREIGN KEY ("createdById") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "nfc" ADD CONSTRAINT "FK_3d237df8b30ecd7b767d8dac921" FOREIGN KEY ("updatedById") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "nfc" ADD CONSTRAINT "FK_8eccba968d06f75fab47a0ff667" FOREIGN KEY ("deletedById") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "nfcScan" ADD CONSTRAINT "FK_641688902c0d8caede9ffd5faf8" FOREIGN KEY ("nfcId") REFERENCES "nfc"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "team" ADD CONSTRAINT "FK_a740aada0e5c9ed5b6344897706" FOREIGN KEY ("deletedById") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "plan" ADD CONSTRAINT "FK_24492da525e9ce18f17b33ccd2d" FOREIGN KEY ("updatedById") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plan" ADD CONSTRAINT "FK_cbe8761b5233cde633f403d97b8" FOREIGN KEY ("createdById") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "plan" DROP CONSTRAINT "FK_cbe8761b5233cde633f403d97b8"`);
        await queryRunner.query(`ALTER TABLE "plan" DROP CONSTRAINT "FK_24492da525e9ce18f17b33ccd2d"`);
        await queryRunner.query(`ALTER TABLE "session" DROP CONSTRAINT "FK_3d2f174ef04fb312fdebd0ddc53"`);
        await queryRunner.query(`ALTER TABLE "team" DROP CONSTRAINT "FK_a740aada0e5c9ed5b6344897706"`);
        ...
        await queryRunner.query(`ALTER TABLE "nfcScan" DROP CONSTRAINT "FK_641688902c0d8caede9ffd5faf8"`);
        await queryRunner.query(`ALTER TABLE "nfc" DROP CONSTRAINT "FK_8eccba968d06f75fab47a0ff667"`);
        await queryRunner.query(`ALTER TABLE "nfc" DROP CONSTRAINT "FK_3d237df8b30ecd7b767d8dac921"`);
        await queryRunner.query(`ALTER TABLE "nfc" DROP CONSTRAINT "FK_f00e4bca6e854074855b2f6ea45"`);
        await queryRunner.query(`ALTER TABLE "nfc" DROP CONSTRAINT "FK_5e5be3957301bc1bc91d2b88617"`);
        await queryRunner.query(`ALTER TABLE "nfcDetail" DROP CONSTRAINT "FK_71781fd56d77ab543a69a72b78b"`);
        await queryRunner.query(`ALTER TABLE "nfcDetail" DROP CONSTRAINT "FK_cd77f5ec4b307314a2c048acbc4"`);
        await queryRunner.query(`ALTER TABLE "nfcDetail" DROP CONSTRAINT "FK_5b00ad4f4af59beba7007cc9c37"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_0b8ef9583319363b07c51a9006"`);
